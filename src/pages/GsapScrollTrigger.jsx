  ...
  return (
    <main>
      <div className="h-screen">
        ...
        <div className="w-full h-[65vh] flex justify-end items-center flex-col">
      ...
      <div
        className="mt-20 w-full h-dvh flex-col space-y-24 justify-end"
        ref={scrollRef}
      >
        <div
          id="scroll-pink"
